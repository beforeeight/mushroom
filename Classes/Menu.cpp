...
bool MenuLayer::init() {
	if (CCMenu::init()) {
		...
		gamename->setPosition(ccpp(0, 0.22));
		...
		CCNode *starttxt = CCLabelBMFont::create(LOCAL_RESOURCES->valueByKey("i18n_start")->getCString(),"fonts.fnt");
		...
		CCNode *rankingtxt = CCLabelBMFont::create(LOCAL_RESOURCES->valueByKey("i18n_ranking")->getCString(),"fonts.fnt");
		...
		CCNode *moretxt = CCLabelBMFont::create(LOCAL_RESOURCES->valueByKey("i18n_more")->getCString(),"fonts.fnt");
		...
		CCNode *feedbacktxt = CCLabelBMFont::create(LOCAL_RESOURCES->valueByKey("i18n_feedback")->getCString(),"fonts.fnt");
